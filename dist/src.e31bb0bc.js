...
},{"gsap":"../node_modules/gsap/index.js"}],"ServiceAPI.js":[function(require,module,exports) {
"use strict";
...
var _default = exports.default = new ServiceAPI();
},{"./App":"App.js","./Auth":"Auth.js","./Toast":"Toast.js"}],"views/pages/Footer.js":[function(require,module,exports) {
"use strict";
...
class TemplateView {
  ...
  render() {
    ...
    (0, _litHtml.render)(template, _App.default.rootEl); // do not change
  }
}
var _default = exports.default = new TemplateView();
},{"./../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","./../../Router":"Router.js","./../../Auth":"Auth.js","./../../Utils":"Utils.js"}],"views/pages/home.js":[function(require,module,exports) {
"use strict";
...
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); } // everything below has been taken from the weekly exercises - template used: va-service.js
...
*/
class HomeServices {
  /*change from a simple view to a more service-focused screen */
  async init() {
    document.title = 'Home';
    this.services = null;
    this.render();
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n  <style>\n  .intro-bar {\n    display: flex;\n    flex-wrap: wrap;\n    align-items: center;\n    background-color: #FFEFCF;\n    padding: 1em; /* Add padding for spacing within the filter menu */\n    border-radius: 0.75em;\n    border: 2px solid #F2AE30; /* Add 'solid' after the border width */\n    box-shadow: 0 0 10px rgba(0, 0, 0, 0.2);\n  }\n\n  .services-grid {\n    display: flex;\n    flex-wrap: wrap;\n    justify-content: center;\n    align-items: center;\n    margin: 0 auto; /* Optional: Center horizontally within its container */\n  }\n  .fav-buttons {\n    display: flex;\n    flex-direction: column; /* Align buttons in a column */\n    align-items: center; /* Center horizontally */\n    gap: 1em; /* Vertical spacing between buttons */\n  }\n\n  .fav-buttons sl-button {\n    width: 100%; /* Set equal width for both buttons */\n  }\n\n  /* Footer styles */\n  .footer {\n    position: fixed;\n    bottom: 0;\n    width: 100%;\n    background-color: #f2be5b;\n    text-align: center;\n    padding: 0;\n  }\n\n  .logo {\n    opacity: 0.65;\n    margin-bottom: -.75em;\n    width: 60px; /* Adjust the width as needed */\n  }\n\n</style>\n\n\n<va-app-header title=\"Home\" user=\"", "\"></va-app-header>\n<div class=\"page-content\"> \n\n<h1 class=\"anim-in\">Hey ", "!</h1>\n\n<div class=\"intro-bar\">\n<div>\n<h3> Check out the latest updates on Furrio! </h3>\n</div>\n</div>\n<br>\n\n<div class=\"services-grid\">\n", "\n\n</div>\n\n\n</div>   \n<div class=\"footer\">\n<img class=\"logo\" src=\"/images/logo.svg\" alt=\"Logo\" />\n<p>DigEx Major Project 1, Curtin University, 2023</p>\n</div>\n\n"])), JSON.stringify(_Auth.default.currentUser), _Auth.default.currentUser.firstName, this.services && this.services.length > 0 && _Auth.default.currentUser.accessLevel === 1 ? this.services.slice(0, 5).map(service => (0, _litHtml.html)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n<va-service class=\"service-card\"\nid=\"", "\"\n  name=\"", "\" \n  description=\"", "\"\n  price=\"", "\"\n  user=\"", "\"\n  image=\"", "\"\n  servicetype=\"", "\"\n  location=\"", "\"\n  >\n</va-service>\n  "])), service._id, service.name, service.description, service.price, JSON.stringify(service.user), service.image, service.servicetype, service.location)) : (0, _litHtml.html)(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n", "\n"])), this.services == null ? (0, _litHtml.html)(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n  <sl-spinner></sl-spinner>\n  "]))) : (0, _litHtml.html)(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["\n  ", "\n  "])), this.services.map(service => (0, _litHtml.html)(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["\n  <va-service class=\"service-card\"\n  id=\"", "\"\n    name=\"", "\" \n    description=\"", "\"\n    price=\"", "\"\n    user=\"", "\"\n    image=\"", "\"\n    servicetype=\"", "\"\n    location=\"", "\"\n    >\n  </va-service>\n    "])), service._id, service.name, service.description, service.price, JSON.stringify(service.user), service.image, service.servicetype, service.location)))));
    (0, _litHtml.render)(template, _App.default.rootEl); // do not change
  }
}
var _default = exports.default = new HomeServices();
},{"./../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","./../../Router":"Router.js","./../../Auth":"Auth.js","./../../Utils":"Utils.js","../../ServiceAPI":"ServiceAPI.js","../../Toast":"Toast.js","./Footer":"views/pages/Footer.js"}],"views/pages/404.js":[function(require,module,exports) {
"use strict";
...
var _templateObject;
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); } // everything below has been taken from the weekly exercises
class SignInView {
  init() {
...
class UserAPI {
  ...
  async addFavService(serviceId) {
    // validate
    if (!serviceId) return;

    // fetch the json data
    const response = await fetch("".concat(_App.default.apiBase, "/user/addFavService"), {
      method: "PUT",
      headers: {
        "Authorization": "Bearer ".concat(localStorage.accessToken),
        "Content-Type": 'application/json'
    ...
    if (!response.ok) {
      ...
      if (err) console.log(err);
      // throw error (exit this function)      
      throw new Error('Problem adding service to favourites');
    }
  ...
  // remove favourite services from the user's collection
  async removeFavService(serviceId) {
    // validate
    if (!serviceId) return;

    // use PUT request to fetch Json Data
    const response = await fetch("".concat(_App.default.apiBase, "/user/removeFavService"), {
      method: "PUT",
      headers: {
        "Authorization": "Bearer ".concat(localStorage.accessToken),
        "Content-Type": 'application/json'
    ...
    if (!response.ok) {
      ...
      if (err) console.log(err);
      // throw error (exit this function)      
      throw new Error('Problem removing service from favourites');
    }
...
},{"./../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","./../../Router":"Router.js","./../../Auth":"Auth.js","./../../Utils":"Utils.js","./../../UserAPI":"UserAPI.js"}],"views/pages/serviceproviders.js":[function(require,module,exports) {
"use strict";
...
class ServicesProviders {
  ...
  // render the template
  render() {
    const template = (0, _litHtml.html)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n    \n    // CSS styling\n    <style>\n    .filter-menu {\n      display: flex;\n      align-items: center;\n      flex-wrap: wrap;\n      justify-content: space-between;\n      background-color: #FFEFCF;\n      padding: 30px; /* Add padding for spacing within the filter menu */\n      border-radius: 0.75em;\n      border: 2px solid #F2AE30; /* Add 'solid' after the border width */\n      box-shadow: 0 0 10px rgba(0, 0, 0, 0.2);\n      margin-bottom: 1em;\n      }\n  \n    .filter-menu > div {\n      margin-right: 40px;\n    }\n  \n    .clear-filters {\n      margin-right: 40px;\n    }\n    \n    /* CSS styling for the service grid*/\n\n    .services-grid {\n      display: flex;\n      flex-wrap: wrap;\n      justify-content: center;\n      align-items: center;\n      margin: 0 auto; /* Optional: Center horizontally within its container */\n    }\n\n    /* Footer styles */\n  .footer {\n    position: fixed;\n    bottom: 0;\n    width: 100%;\n    text-align: center;\n    padding: 0;\n  }\n\n  .logo {\n    opacity: 0.65;\n    margin-bottom: -.75em;\n    width: 60px; /* Adjust the width as needed */\n  }\n\n  </style>\n  \n  /* everything below has been taken from the weekly exercises*/\n\n  <va-app-header title=\"Service Providers\" user=\"", "\"></va-app-header>\n  <div class=\"page-content\"> \n    <div class=\"filter-menu\">\n      <div>\n      <strong> Filter By</strong>\n      </div>\n      <div>\n        <strong> Service Type </strong>\n        <sl-button class=\"filter-btn\" size=\"small\" data-field=\"servicetype\" data-match=\"veterinary\" @click=", ">Veterinary</sl-button>\n        <sl-button class=\"filter-btn\" size=\"small\" data-field=\"servicetype\" data-match=\"petGrooming\" @click=", ">Pet Grooming</sl-button>\n        <sl-button class=\"filter-btn\" size=\"small\" data-field=\"servicetype\" data-match=\"petSitting\" @click=", ">Pet Sitting</sl-button>\n        <sl-button class=\"filter-btn\" size=\"small\" data-field=\"servicetype\" data-match=\"dogWalking\" @click=", ">Dog Walking</sl-button>\n        \n        <strong> City </strong>\n        <sl-button class=\"filter-btn\" size=\"small\" data-field=\"location\" data-match=\"sydney\" @click=", ">Sydney</sl-button>\n        <sl-button class=\"filter-btn\" size=\"small\" data-field=\"location\" data-match=\"melbourne\" @click=", ">Melbourne</sl-button>\n        <sl-button class=\"filter-btn\" size=\"small\" data-field=\"location\" data-match=\"canberra\" @click=", ">Canberra</sl-button>\n        <sl-button class=\"filter-btn\" size=\"small\" data-field=\"location\" data-match=\"brisbane\" @click=", ">Brisbane</sl-button>\n        <sl-button class=\"filter-btn\" size=\"small\" data-field=\"location\" data-match=\"adelaide\" @click=", ">Adelaide</sl-button>\n        <sl-button class=\"filter-btn\" size=\"small\" data-field=\"location\" data-match=\"perth\" @click=", ">Perth</sl-button>\n        <sl-button class=\"filter-btn\" size=\"small\" data-field=\"location\" data-match=\"hobart\" @click=", ">Hobart</sl-button>\n        <sl-button class=\"filter-btn\" size=\"small\" data-field=\"location\" data-match=\"darwin\" @click=", ">Darwin</sl-button>\n   </div>\n      <div>\n        <sl-button size=\"small\" @click=", "> Clear filters</sl-button>\n      </div>\n    </div>\n\n<div class=\"services-grid\">\n", "\n</div>\n\n\n         \n</div>      \n<div class=\"footer\">\n<img class=\"logo\" src=\"/images/logo.svg\" alt=\"Logo\" />\n<p>DigEx Major Project 1, Curtin University, 2023</p>\n</div>     \n"])), JSON.stringify(_Auth.default.currentUser), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.clearFilters.bind(this), this.services == null ? (0, _litHtml.html)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n<sl-spinner>\n</sl-spinner>\n"]))) : (0, _litHtml.html)(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n", "\n"])), this.services.map(service => (0, _litHtml.html)(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n  <va-service-provider class=\"service-card\"\n    id=\"", "\"\n    name=\"", " ", "\" \n    email=\"", "\" \n    servicetype=\"", "\"\n    image=\"", "\"\n    location=\"", "\"\n    >\n  </va-service-provider>\n\n  "])), service.user._id, service.user.firstName, service.user.lastName, service.user.email, service.servicetype, service.user.avatar !== undefined ? service.user.avatar : "No-Image-Placeholder.png", service.location))));
    (0, _litHtml.render)(template, _App.default.rootEl); // do not change
  }
}
var _default = exports.default = new ServicesProviders();
},{"../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../Router":"Router.js","../../Auth":"Auth.js","../../Utils":"Utils.js","../../ServiceAPI":"ServiceAPI.js","../../Toast":"Toast.js"}],"views/pages/services.js":[function(require,module,exports) {
"use strict";
...
class ServicesView {
  ...
  // render the template
  render() {
    const template = (0, _litHtml.html)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n    <style>\n    .filter-menu {\n      display: flex;\n      align-items: center;\n      flex-wrap: wrap;\n      justify-content: space-between;\n      background-color: #FFEFCF;\n      padding: 30px; /* Add padding for spacing within the filter menu */\n      border-radius: 0.75em;\n      border: 2px solid #F2AE30; /* Add 'solid' after the border width */\n      box-shadow: 0 0 10px rgba(0, 0, 0, 0.2);\n    }\n  \n    .filter-menu > div {\n      margin-right: 40px;\n    }\n  \n    .clear-filters {\n      margin-right: 40px;\n    }\n\n    .services-grid {\n      display: flex;\n      flex-wrap: wrap;\n      justify-content: center;\n      align-items: center;\n      margin: 0 auto; /* Optional: Center horizontally within its container */\n    }\n    /* Footer styles */\n    .footer {\n      position: fixed;\n      bottom: 0;\n      width: 100%;\n      text-align: center;\n      background-color: #333;\n      color: white;\n      padding: 20px 0;\n    }\n\n    .logo {\n      opacity: 0.65;\n      width: 60px; /* Adjust the width as needed */\n      filter: brightness(120%) sepia(100%) hue-rotate(180deg) saturate(300%);\n    }\n  </style>\n  \n\n  <va-app-header title=\"Services\" user=\"", "\"></va-app-header>\n  <div class=\"page-content\"> \n    <div class=\"filter-menu\">\n      <div>\n      <strong> Filter By </strong>\n      </div>\n      <div>\n        <strong> Service Type </strong>\n        <sl-button class=\"filter-btn\" size=\"small\" data-field=\"servicetype\" data-match=\"veterinary\" @click=", ">Veterinary</sl-button>\n        <sl-button class=\"filter-btn\" size=\"small\" data-field=\"servicetype\" data-match=\"petGrooming\" @click=", ">Pet Grooming</sl-button>\n        <sl-button class=\"filter-btn\" size=\"small\" data-field=\"servicetype\" data-match=\"petSitting\" @click=", ">Pet Sitting</sl-button>\n        <sl-button class=\"filter-btn\" size=\"small\" data-field=\"servicetype\" data-match=\"dogWalking\" @click=", ">Dog Walking</sl-button>\n        \n        <strong> City </strong>\n        <sl-button class=\"filter-btn\" size=\"small\" data-field=\"location\" data-match=\"sydney\" @click=", ">Sydney</sl-button>\n        <sl-button class=\"filter-btn\" size=\"small\" data-field=\"location\" data-match=\"melbourne\" @click=", ">Melbourne</sl-button>\n        <sl-button class=\"filter-btn\" size=\"small\" data-field=\"location\" data-match=\"canberra\" @click=", ">Canberra</sl-button>\n        <sl-button class=\"filter-btn\" size=\"small\" data-field=\"location\" data-match=\"brisbane\" @click=", ">Brisbane</sl-button>\n        <sl-button class=\"filter-btn\" size=\"small\" data-field=\"location\" data-match=\"adelaide\" @click=", ">Adelaide</sl-button>\n        <sl-button class=\"filter-btn\" size=\"small\" data-field=\"location\" data-match=\"perth\" @click=", ">Perth</sl-button>\n        <sl-button class=\"filter-btn\" size=\"small\" data-field=\"location\" data-match=\"hobart\" @click=", ">Hobart</sl-button>\n        <sl-button class=\"filter-btn\" size=\"small\" data-field=\"location\" data-match=\"darwin\" @click=", ">Darwin</sl-button>\n\n        <strong> Price</strong>\n        <sl-button class=\"filter-btn\" size=\"small\" data-field=\"price\" data-match=\"10-50\" @click=", ">$10-50</sl-button>\n        <sl-button class=\"filter-btn\" size=\"small\" data-field=\"price\" data-match=\"50-100\" @click=", ">$50-100</sl-button>\n        <sl-button class=\"filter-btn\" size=\"small\" data-field=\"price\" data-match=\"100-150\" @click=", ">$100-150</sl-button>\n      </div>\n      <div>\n        <sl-button size=\"small\" @click=", "> Clear filters</sl-button>\n      </div>\n    </div>\n\n<div class=\"services-grid\">\n", "\n</div>\n         \n</div>      \n   \n"])), JSON.stringify(_Auth.default.currentUser), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.clearFilters.bind(this), this.services == null ? (0, _litHtml.html)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n<sl-spinner></sl-spinner>\n"]))) : (0, _litHtml.html)(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n", "\n"])), this.services.map(service => (0, _litHtml.html)(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n  <va-service class=\"service-card\"\n  id=\"", "\"\n    name=\"", "\" \n    description=\"", "\"\n    price=\"", "\"\n    user=\"", "\"\n    image=\"", "\"\n    servicetype=\"", "\"\n    location=\"", "\"\n    >\n  </va-service>\n\n  "])), service._id, service.name, service.description, service.price, JSON.stringify(service.user), service.image, service.servicetype, service.location))));
    (0, _litHtml.render)(template, _App.default.rootEl); // do not change
  }
}
var _default = exports.default = new ServicesView();
},{"../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../Router":"Router.js","../../Auth":"Auth.js","../../Utils":"Utils.js","../../ServiceAPI":"ServiceAPI.js","../../Toast":"Toast.js"}],"views/pages/favouriteServices.js":[function(require,module,exports) {
"use strict";
...
class favouriteServicesView {
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n      <va-app-header title=\"Favourite Services\" user=\"", "\"></va-app-header>\n      <div class=\"page-content\">        \n        <style>\n        .filter-menu {\n          display: flex;\n          align-items: center;\n          flex-wrap: wrap;\n          justify-content: space-between;\n          background-color: #FFEFCF;\n          padding: 30px; /* Add padding for spacing within the filter menu */\n          border-radius: 0.75em;\n          border: 2px solid #F2AE30; /* Add 'solid' after the border width */\n          box-shadow: 0 0 10px rgba(0, 0, 0, 0.2);\n        }\n      \n        .filter-menu > div {\n          margin-right: 40px;\n        }\n      \n        .clear-filters {\n          margin-right: 40px;\n        }\n    \n        .services-grid {\n          display: flex;\n          flex-wrap: wrap;\n          justify-content: center;\n          align-items: center;\n          margin: 0 auto; /* Optional: Center horizontally within its container */\n        }\n        /* Footer styles */\n        .footer {\n          position: fixed;\n          bottom: 0;\n          width: 100%;\n          text-align: center;\n          padding: 0;\n        }\n      \n        .logo {\n          opacity: 0.65;\n          margin-bottom: -.75em;\n          width: 60px; /* Adjust the width as needed */\n        }\n\n      </style>\n        <div class=\"services-grid\">\n        ", "\n        </div>\n      </div>  \n      \n          \n      <div class=\"footer\">\n      <img class=\"logo\" src=\"/images/logo.svg\" alt=\"Logo\" />\n      <p>DigEx Major Project 1, Curtin University, 2023</p>\n      </div>\n      \n    "])), JSON.stringify(_Auth.default.currentUser), this.favServices == null ? (0, _litHtml.html)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n          <sl-spinner></sl-spinner>\n        "]))) : (0, _litHtml.html)(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n          ", "\n        "])), this.favServices.map(service => (0, _litHtml.html)(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n            <va-service class=\"service-card\"\n              id=\"", "\"\n              name=\"", "\"\n              description=\"", "\"\n              price=\"", "\"\n              user=\"", "\"\n              image=\"", "\"\n              servicetype=\"", "\"\n              location=\"", "\"\n            >        \n            </va-service>\n\n          "])), service._id, service.name, service.description, service.price, JSON.stringify(service.user), service.image, service.servicetype, service.location))));
    (0, _litHtml.render)(template, _App.default.rootEl); // do not change
  }
}
var _default = exports.default = new favouriteServicesView();
},{"../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","../../Router":"Router.js","../../Auth":"Auth.js","../../Utils":"Utils.js","../../Toast":"Toast.js","../../UserAPI":"UserAPI.js"}],"views/pages/newService.js":[function(require,module,exports) {
"use strict";
...
class newServiceView {
  ...
  async newServiceSubmitHandler(e) {
    ...
    const formData = e.detail.formData;
    try {
      await _ServiceAPI.default.newService(formData);
      _Toast.default.show('Service added!');
      submitBtn.removeAttribute('loading');
      // reset form
...
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); } // everything below has been taken from the weekly exercises - template used: services.js
...
class myServicesView {
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n    <style>\n    .filter-menu {\n      display: flex;\n      align-items: center;\n      flex-wrap: wrap;\n      justify-content: space-between;\n      background-color: #FFEFCF;\n      padding: 30px; /* Add padding for spacing within the filter menu */\n      border-radius: 0.75em;\n      border: 2px solid #F2AE30; /* Add 'solid' after the border width */\n      box-shadow: 0 0 10px rgba(0, 0, 0, 0.2);\n    }\n  \n    .filter-menu > div {\n      margin-right: 40px;\n    }\n  \n    .clear-filters {\n      margin-right: 40px;\n    }\n\n    .services-grid {\n      display: flex;\n      flex-wrap: wrap;\n      justify-content: center;\n      align-items: center;\n      margin: 0 auto; /* Optional: Center horizontally within its container */\n    }\n\n    /* Footer styles */\n  .footer {\n    position: fixed;\n    bottom: 0;\n    width: 100%;\n    text-align: center;\n    padding: 0;\n  }\n\n  .logo {\n    opacity: 0.65;\n    margin-bottom: -.75em;\n    width: 60px; /* Adjust the width as needed */\n  }\n\n  </style>\n  \n\n  <va-app-header title=\"My Services\" user=\"", "\"></va-app-header>\n  <div class=\"page-content\"> \n    <div class=\"filter-menu\">\n      <div>\n      <strong> Filter By</strong>\n      </div>\n      <div>\n        <strong> Service Type </strong>\n        <sl-button class=\"filter-btn\" size=\"small\" data-field=\"servicetype\" data-match=\"veterinary\" @click=", ">Veterinary</sl-button>\n        <sl-button class=\"filter-btn\" size=\"small\" data-field=\"servicetype\" data-match=\"petGrooming\" @click=", ">Pet Grooming</sl-button>\n        <sl-button class=\"filter-btn\" size=\"small\" data-field=\"servicetype\" data-match=\"petSitting\" @click=", ">Pet Sitting</sl-button>\n        <sl-button class=\"filter-btn\" size=\"small\" data-field=\"servicetype\" data-match=\"dogWalking\" @click=", ">Dog Walking</sl-button>\n        \n        <strong> City </strong>\n        <sl-button class=\"filter-btn\" size=\"small\" data-field=\"location\" data-match=\"sydney\" @click=", ">Sydney</sl-button>\n        <sl-button class=\"filter-btn\" size=\"small\" data-field=\"location\" data-match=\"melbourne\" @click=", ">Melbourne</sl-button>\n        <sl-button class=\"filter-btn\" size=\"small\" data-field=\"location\" data-match=\"canberra\" @click=", ">Canberra</sl-button>\n        <sl-button class=\"filter-btn\" size=\"small\" data-field=\"location\" data-match=\"brisbane\" @click=", ">Brisbane</sl-button>\n        <sl-button class=\"filter-btn\" size=\"small\" data-field=\"location\" data-match=\"adelaide\" @click=", ">Adelaide</sl-button>\n        <sl-button class=\"filter-btn\" size=\"small\" data-field=\"location\" data-match=\"perth\" @click=", ">Perth</sl-button>\n        <sl-button class=\"filter-btn\" size=\"small\" data-field=\"location\" data-match=\"hobart\" @click=", ">Hobart</sl-button>\n        <sl-button class=\"filter-btn\" size=\"small\" data-field=\"location\" data-match=\"darwin\" @click=", ">Darwin</sl-button>\n   </div>\n      <div>\n        <sl-button size=\"small\" @click=", "> Clear filters</sl-button>\n      </div>\n    </div>\n\n<div class=\"services-grid\">\n\n\n", "\n\n\n\n</div>\n      \n</div>      \n\n<div class=\"footer\">\n<img class=\"logo\" src=\"/images/logo.svg\" alt=\"Logo\" />\n<p>DigEx Major Project 1, Curtin University, 2023</p>\n</div>     \n"])), JSON.stringify(_Auth.default.currentUser), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.handleFilterBtn.bind(this), this.clearFilters.bind(this), this.services !== null ? this.services.filter(service => JSON.stringify(_Auth.default.currentUser._id) === JSON.stringify(service.user._id)).map(service => (0, _litHtml.html)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n      <va-service class=\"service-card\"\n      id=\"", "\"\n        name=\"", "\"\n        description=\"", "\"\n        price=\"", "\"\n        user=\"", "\"\n        image=\"", "\"\n        servicetype=\"", "\"\n        location=\"", "\"\n        >\n      </va-service>\n      "])), service._id, service.name, service.description, service.price, JSON.stringify(service.user), service.image, service.servicetype, service.location)) : (0, _litHtml.html)(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["<p>No records found.</p>"]))));
    (0, _litHtml.render)(template, _App.default.rootEl); // do not change
  }
}
var _default = exports.default = new myServicesView();
...
var _serviceproviders = _interopRequireDefault(require("./views/pages/serviceproviders"));
var _services = _interopRequireDefault(require("./views/pages/services"));
var _favouriteServices = _interopRequireDefault(require("./views/pages/favouriteServices"));
var _newService = _interopRequireDefault(require("./views/pages/newService"));
var _bookings = _interopRequireDefault(require("./views/pages/bookings"));
...
const routes = {
  ...
  '/serviceproviders': _serviceproviders.default,
  '/services': _services.default,
  '/favouriteServices': _favouriteServices.default,
  '404': _.default,
  '/signin': _signin.default,
  '/signup': _signup.default,
  '/profile': _profile.default,
  '/editProfile': _editProfile.default,
  '/newService': _newService.default,
...
},{"./views/pages/home":"views/pages/home.js","./views/pages/404":"views/pages/404.js","./views/pages/signin":"views/pages/signin.js","./views/pages/signup":"views/pages/signup.js","./views/pages/profile":"views/pages/profile.js","./views/pages/editProfile":"views/pages/editProfile.js","./views/pages/guide":"views/pages/guide.js","./views/pages/serviceproviders":"views/pages/serviceproviders.js","./views/pages/services":"views/pages/services.js","./views/pages/favouriteServices":"views/pages/favouriteServices.js","./views/pages/newService":"views/pages/newService.js","./views/pages/bookings":"views/pages/bookings.js","./views/pages/myServices":"views/pages/myServices.js"}],"App.js":[function(require,module,exports) {
"use strict";
...
customElements.define('va-app-header', class AppHeader extends _litElement.LitElement {
  ...
  render() {
    return (0, _litElement.html)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n    <style>      \n      * {\n        box-sizing: border-box;\n      }\n      .app-header {\n        background: var(--brand-color);\n        position: fixed;\n        top: 0;\n        right: 0;\n        left: 0;\n        height: var(--app-header-height);\n        color: #fff;\n        display: flex;\n        z-index: 9;\n        box-shadow: 4px 0px 10px rgba(0,0,0,0.2);\n        align-items: center;\n      }\n     \n\n\n      .app-header-main {\n        flex-grow: 1;\n        display: flex;\n        align-items: center;\n      }\n\n\n      .app-header-main::slotted(h1){\n        color: #fff;\n      }\n\n\n      .app-logo a {\n        color: #fff;\n        text-decoration: none;\n        font-weight: bold;\n        font-size: 1.2em;\n        padding: .6em;\n        display: inline-block;        \n      }\n\n\n      .app-logo img {\n        width: 90px;\n      }\n     \n      .hamburger-btn::part(base) {\n        color: #fff;\n      }\n\n\n      .app-top-nav {\n        display: flex;\n        height: 100%;\n        align-items: center;\n      }\n\n\n      .app-top-nav a {\n        display: inline-block;\n        padding: .8em;\n        text-decoration: none;\n        color: #fff;\n      }\n     \n      .app-side-menu-items a {\n        display: block;\n        padding: .5em;\n        text-decoration: none;\n        font-size: 1.3em;\n        color: #333;\n      }\n\n\n      .app-side-menu-logo {\n        width: 120px;\n        margin-bottom: 1em;\n        position: absolute;\n        top: 2em;\n        left: 1.5em;\n      }\n\n\n      .page-title {\n        color: var(--app-header-txt-color);\n        margin-right: 0.5em;\n        font-size: var(--app-header-title-font-size);\n      }\n\n\n      /* active nav links */\n      .app-top-nav a.active,\n      .app-side-menu-items a.active {\n        font-weight: bold;\n      }\n\n\n      /* RESPONSIVE - MOBILE ------------------- */\n      @media all and (max-width: 768px){      \n       \n        .app-top-nav {\n          display: none;\n        }\n      }\n\n\n    </style>\n\n\n    <header class=\"app-header\">\n      <sl-icon-button class=\"hamburger-btn\" name=\"list\" @click=\"", "\" style=\"font-size: 1.5em;\"></sl-icon-button>      \n     \n      <div class=\"app-header-main\">\n        ", "\n        <slot></slot>\n      </div>\n\n\n      <nav class=\"app-top-nav\">\n        <a href=\"/\" @click=\"", "\">\n        <img src=\"/images/icons_home2.svg\" alt=\"Home\" style=\"width: 16px; height: 16px; margin-right: 10px;\">\n        Home</a>\n        ", "    \n        \n        <sl-dropdown>\n          <a slot=\"trigger\" href=\"#\" @click=\"", "\">\n            <sl-avatar style=\"--size: 24px;\" image=", "></sl-avatar> ", "\n          </a>\n          <sl-menu>            \n          <sl-menu-item @click=\"", "\">\n            <img src=\"/images/icons_profile.svg\" alt=\"Profile\" style=\"width: 16px; height: 16px; margin-right: 10px;\">\n            Profile\n          </sl-menu-item>\n          \n          <sl-menu-item @click=\"", "\">\n            <img src=\"/images/icons_editprofile.svg\" alt=\"Edit Profile\" style=\"width: 16px; height: 16px; margin-right: 10px;\">\n            Edit Profile\n          </sl-menu-item>\n          \n          <sl-menu-item @click=\"", "\">\n            <img src=\"/images/icons_logout.svg\" alt=\"Sign Out\" style=\"width: 16px; height: 16px; margin-right: 10px;\">\n            Sign Out\n          </sl-menu-item>\n        </sl-menu>\n        \n        </sl-dropdown>\n      </nav>\n    </header>\n\n\n    <sl-drawer class=\"app-side-menu\" placement=\"left\">\n    <img class=\"app-side-menu-logo\" src=\"/images/logo.svg\">\n    <nav class=\"app-side-menu-items\">\n    <a href=\"/\" @click=\"", "\">\n    <img src=\"/images/icons_home.svg\" alt=\"Home\" style=\"width: 22px; height: 22px; margin-right: 20px;\">Home\n  </a>\n      \n      ", "\n    \n      <a href=\"/profile\" @click=\"", "\">\n      <img src=\"/images/icons_profile.svg\" alt=\"Profile\" style=\"width: 22px; height: 22px; margin-right: 20px;\">\n      Profile</a>\n      <a href=\"#\" @click=\"", "\">\n      <img src=\"/images/icons_logout.svg\" alt=\"Sign Out\" style=\"width: 22px; height: 22px; margin-right: 20px;\">\n      Sign Out</a>\n    </nav>  \n  </sl-drawer>\n    "])), this.hamburgerClick, this.title ? (0, _litElement.html)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n          <h1 class=\"page-title\">", "</h1>\n        "])), this.title) : "", _Router.anchorRoute, this.user.accessLevel == 2 ? (0, _litElement.html)(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n        <a href=\"/newService\" @click=\"", "\">\n        <img src=\"/images/icons_addservice.svg\" alt=\"Add Service\" style=\"width: 16px; height: 16px; margin-right: 10px;\">\n        Add Service</a>    \n        "])), _Router.anchorRoute) : "", e => e.preventDefault(), this.user && this.user.avatar ? "".concat(_App.default.apiBase, "/images/").concat(this.user.avatar) : '', this.user && this.user.firstName, () => (0, _Router.gotoRoute)('/profile'), () => (0, _Router.gotoRoute)('/editProfile'), () => _Auth.default.signOut(), this.menuClick, this.user.accessLevel === 1 ? (0, _litElement.html)(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n        <a href=\"/services\" @click=\"", "\">\n        <img src=\"/images/icons_services.svg\" alt=\"Services\" style=\"width: 22px; height: 22px; margin-right: 20px;\">\n        Services\n        </a>\n        \n        <a href=\"/serviceproviders\" @click=\"", "\">\n        <img src=\"/images/icons_serviceproviders.svg\" alt=\"Service Providers\" style=\"width: 22px; height: 22px; margin-right: 20px;\">\n        Service Providers\n        </a>\n          \n        <a href=\"/favouriteServices\" @click=\"", "\">\n        <img src=\"/images/icons_favourites.svg\" alt=\"Favourites\" style=\"width: 22px; height: 22px; margin-right: 20px;\">\n        Favourites\n        </a>\n\n        <a href=\"/bookings\" @click=\"", "\">\n        <img src=\"/images/icons_bookings.svg\" alt=\"Bookings\" style=\"width: 22px; height: 22px; margin-right: 20px;\">\n        Bookings\n        </a>\n\n        "])), this.menuClick, this.menuClick, this.menuClick, this.menuClick) : this.user.accessLevel === 2 ? (0, _litElement.html)(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["\n        <a href=\"/myServices\" @click=\"", "\">\n        <img src=\"/images/icons_services.svg\" alt=\"My Services\" style=\"width: 22px; height: 22px; margin-right: 20px;\">\n        My Services\n        </a>\n      \n        <a href=\"/bookings\" @click=\"", "\">\n        <img src=\"/images/icons_bookings.svg\" alt=\"My Bookings\" style=\"width: 22px; height: 22px; margin-right: 20px;\">\n        My Bookings\n        </a>\n        "])), this.menuClick, this.menuClick) : (0, _litElement.html)(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral([""]))), this.menuClick, () => _Auth.default.signOut());
  }
});
},{"@polymer/lit-element":"../node_modules/@polymer/lit-element/lit-element.js","./../Router":"Router.js","./../Auth":"Auth.js","./../App":"App.js"}],"ServiceProviderAPI.js":[function(require,module,exports) {
"use strict";
...
class ServiceProvidersAPI {
  async getAllServiceProviders() {
    try {
      const response = await fetch("".concat(_App.default.apiBase, "/service-providers"), {
        headers: {
          Authorization: "Bearer ".concat(localStorage.accessToken)
        }
      });
      ...
      // catch and throw any errors if they come about during this process
      throw error;
    }
  }
  ...
  async getServiceProvider(providerId) {
    try {
      ...
      const response = await fetch("".concat(_App.default.apiBase, "/service-providers/").concat(providerId), {
        headers: {
          Authorization: "Bearer ".concat(localStorage.accessToken)
        }
      });
...
var _default = exports.default = new ServiceProvidersAPI();
},{"./App":"App.js"}],"components/va-service.js":[function(require,module,exports) {
"use strict";
...
var _UserAPI = _interopRequireDefault(require("../UserAPI"));
var _Toast = _interopRequireDefault(require("../Toast"));
var _ServiceProviderAPI = _interopRequireDefault(require("../ServiceProviderAPI"));
...
customElements.define('va-service', class Service extends _litElement.LitElement {
  ...
  moreInfoHandler() {
    ...
    const dialogContent = (0, _litElement.html)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n        <style>\n        .wrap {\n            display: flex;\n        }\n        .image {\n            width: 50%;\n        }\n        .image img {\n            width: 100%;\n        }\n        .content {\n            padding-left: 1em;\n        }\n        .servicetype span,\n        .location span {\n            text-transform: uppercase;\n            font-weight: bold;\n        }\n        .price {\n            font-size: 1.5em;\n            color: var(--brand-color)\n        }\n\n        // additional styling for the fav button\n\n        .fav-buttons {\n          display: flex;\n\n        }\n\n        .service-image {\n          width: 100px;\n          height: auto;\n        }\n        </style>\n\n        <div class=\"wrap\">\n        <div class=\"image\">\n            <img src=\"", "/images/", "\" alt=\"", "\" />\n        </div>\n        <div class=\"content\">\n            <h1>", "</h1>\n            <p>", "</p>\n            <p class=\"price\">$", "</p>\n            <p class=\"servicetype\">servicetype: <span>", "</span></p>\n            <p class=\"location\">location: <span>", "</span></p>\n            <div class=\"fav-buttons\">\n            <sl-button style=\"width: 15em; margin-bottom: 10px;\" @click=", ">Add to Favourites</sl-button>\n            <sl-button style=\"width: 15em; margin-bottom: 10px;\" @click=", ">Remove from Favourites</sl-button>\n          </div>\n        </div>\n        </div>\n        </div>\n        "])), _App.default.apiBase, this.image, this.name, this.name, this.description, this.price, this.servicetype, this.location, this.addFavHandler, this.removeFavHandler);
  ...
  async addFavHandler() {
    try {
      _UserAPI.default.addFavService(this.id);
      _Toast.default.show('Service added to favourites');
    } catch (err) {
      console.error(err); // Log any error that occurred
      _Toast.default.show('Failed to add service to favorites', 'error');
    }
  }
  ...
  async removeFavHandler() {
    try {
      _UserAPI.default.removeFavService(this.id);
      _Toast.default.show('Service Removed from favourites');
    } catch (err) {
      _Toast.default.show(err, 'error');
    }
  }
  render() {
    return (0, _litElement.html)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n    <style>\n    .author {\n        font-size: 0.9em;\n        font-style: italic;\n        opacity: 0.8;\n    }\n\n    //additional content styling\n    .card-buttons {\n      display: flex;\n      justify-content: space-between;\n      margin-top: 10px;\n      cursor:pointer\n    }\n  \n    .card-buttons sl-icon-button {\n      flex: 1;\n    }\n  \n    .card-buttons sl-icon-button sl-icon {\n      width: 24px;\n      height: 24px;\n    }\n  \n    .card-image {\n      width: 100%; \n      height: 200px;\n      object-fit: cover;\n    }\n    .display-flex{\n      cursor:pointer\n      gap: 14px;\n      display: flex;\n    }\n    .heartIcons{\n      color: turquoise;\n      margin-top: 15px;\n    }\n\n    .fav-buttons {\n      display: flex;\n      flex-direction: column; /* Align buttons in a column */\n      align-items: center; /* Center horizontally */\n      gap: 1em; /* Vertical spacing between buttons */\n    }\n  \n    .fav-buttons sl-button {\n      width: 100%; /* Set equal width for both buttons */\n    }\n\n    </style> \n    <sl-card>\n  <img slot=\"image\" class=\"card-image\" src=\"", "/images/", "\" alt=\"", "\" />\n  <h2>", "</h2>\n  <h3>$", "</h3>\n  <p class=\"author\">By ", "</p>\n  <sl-button @click=", ">More info</sl-button>\n  <sl-icon-button name=\"heart-fill\" label=\"Add to Favourites\" @click=", "></sl-icon-button>\n</sl-card>\n\n"])), _App.default.apiBase, this.image, this.name, this.name, this.price, this.user ? "".concat(this.user.firstName, " ").concat(this.user.lastName) : 'Unknown', this.moreInfoHandler.bind(this), this.addFavHandler.bind(this));
  }
});
},{"@polymer/lit-element":"../node_modules/@polymer/lit-element/lit-element.js","lit-html":"../node_modules/lit-html/lit-html.js","../Router":"Router.js","../Auth":"Auth.js","../App":"App.js","../UserAPI":"UserAPI.js","../Toast":"Toast.js","../ServiceProviderAPI":"ServiceProviderAPI.js"}],"components/va-service-provider.js":[function(require,module,exports) {
"use strict";
...
customElements.define('va-service-provider', class ServiceProvider extends _litElement.LitElement {
  constructor() {
    super();
  }
  static get properties() {
  ...
  moreInfoHandler() {
    ...
    // sl-dialog content
    const dialogContent = (0, _litElement.html)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n        <style>\n        .wrap {\n            display: flex;\n        }\n        .image {\n            width: 50%;\n        }\n        .image img {\n            width: 100%;\n        }\n        .content {\n            padding-left: 1em;\n        }\n        .servicetype span,\n        .location span {\n            text-transform: uppercase;\n            font-weight: bold;\n        }\n        .price {\n            font-size: 1.5em;\n            color: var(--brand-color)\n\n      .contact {\n            font-size: 1.5em;\n            color: var(--brand-color)    \n        }\n        </style>\n        <div class=\"wrap\">\n        <div class=\"image\">\n            <img src=\"", "/images/", "\" alt=\"", "\" />\n        </div>\n        <div class=\"content\">\n            <h1>", "</h1>\n            <p class=\"servicetype\">Services I provide: <span>", "</span></p>\n            <p class=\"location\">My Location: <span>", "</span></p>\n\n\n        </div>\n        </div>\n        "])), _App.default.apiBase, this.image, this.image, this.name, this.servicetype, this.location);
    (0, _litHtml.render)(dialogContent, dialogEl);
  ...
  async addFavHandler() {
    try {
      _UserAPI.default.updateFavoriteService(this.id);
      _Toast.default.show('Service added to favourites');
    } catch (err) {
      _Toast.default.show(err, 'error');
    }
...
require("./components/va-service-provider");
...
// this needs to be added similar to va-service 
// styles
// app.init
document.addEventListener('DOMContentLoaded', () => {
  _App.default.init();
});
},{"./App.js":"App.js","./components/va-app-header":"components/va-app-header.js","./components/va-service":"components/va-service.js","./components/va-service-provider":"components/va-service-provider.js","./scss/master.scss":"scss/master.scss"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
